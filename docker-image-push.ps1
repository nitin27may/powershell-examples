param (
  ...
  [string]$imageName = "dockerdemo", # image name
  ...
  [string]$workspace = "D:\Workplace\DockerDemo" # Source code where dockerfile is present 
  # https://github.com/nitin27may/powershell-examples.git demo project
)
